...
export default function WaveInterferenceExperiment() {
  ...
  // Simulation component to pass to the layout
  ...
  // Controls component to pass to the layout
  ...
  // Information component to pass to the layout
  const infoComponent = (
    <>
  ...
  // Additional info for controls section
